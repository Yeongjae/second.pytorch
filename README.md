...
Then run
```bash
python create_data.py nuscenes_data_prep --root_path=NUSCENES_DATASET_ROOT --version="v1.0-trainval" --max_sweeps=10 --dataset_name="NuScenesDataset"
python create_data.py nuscenes_data_prep --root_path=NUSCENES_DATASET_ROOT --version="v1.0-test" --max_sweeps=10 --dataset_name="NuScenesDataset"
python create_data.py nuscenes_data_prep --root_path=NUSCENES_DATASET_ROOT --version="v1.0-mini" --max_sweeps=10 --dataset_name="NuScenesDataset"
```
